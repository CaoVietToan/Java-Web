...
<body class="" style="background-color:#FFCCFF;">
    ...
    <div class="row" style="background-color:#FFCCFF;">
        <div class="col-lg-3">
         <jsp:include page="common/sidebar.jsp"></jsp:include>
            <jsp:include page="common/sliderbar2.jsp"></jsp:include>
        </div>
        <div class="col-lg-9" style="background-color:#FFCCFF;">
            <div class="album py-5 bg-light rounded shadow" >
            	<form class="nav-item d-flex ms-4 mb-2" action="home">
                    <input class="form-control me-auto" type="search" name="search" placeholder="Search"
                           aria-label="Search">
                    <button class="btn btn-outline-success ms-2 me-2" type="submit">Tìm kiếm</button>
                </form>
                <hr>	
                <div class="container" style="background-color:#FFCCFF;">
                            ...
                            <div class="col">
                                <div class="card shadow-sm" style="width: 240px;">
                                    ...
                                    <div class="card-body" style="height: 160px;">
                                        <h6 class="card-title text-primary title-book">${s.getTenGiay()}
                                        </h6>
                                        <div class="card-text d-flex align-items-center justify-content-between">
                                                <span class="text-bolder" style="font-size: 20px;font-weight: 500;">${s.getGia()}đ
                                                </span>
                                            <em class="text-muted">--${s.getMota()}--</em>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mt-2">
                                            <div class="btn-group">
                                                <a href="handle-cart?mg=${s.getMaGiay()}&tg=${s.getTenGiay()}&gia=${s.getGia()}&anh=${s.getAnh()}"
	                      ...
	                      <ul class="pagination"> 
	                        ...
	                        <c:if test="${not empty maloai}">
		                        <li class="page-item <c:if test="${p == 1}">disabled</c:if>">
		                          <a class="page-link " href="home?page=${p-1}&cId=${maloai}" aria-label="Previous">
		                            <span aria-hidden="true">&laquo;</span>
		                          </a>
		                        </li>
	                        	<c:forEach begin="${begin}" end="${end}" var="number">
	                        	<li class="page-item <c:if test="${number == p}">active</c:if>">
	                        		<a class="page-link" href="home?page=${number}&cId=${maloai}">${number}</a></li>
		                    	</c:forEach>
		                    	<li class="page-item <c:if test="${p == end}">disabled</c:if>">
		                          <a class="page-link" href="home?page=${p+1}&cId=${maloai}" aria-label="Next">
