	                          ...
	                          <tr>
	                            ...
	                            <td>
	                            	<c:if test="${item.isTrangthai() == true }">
	                            		<span class="badge bg-success" style="color:grey;">Đã thanh toán</span>
	                            	</c:if>
	                            	<c:if test="${item.isTrangthai() == false }">
	                            		<span class="badge bg-danger" style="color:green;">Chưa thanh toán</span>
	                            	</c:if>
								</td>
								<td>
									<a href="order-detail?orderId=${item.getMahd()}" class="btn btn-primary">Xem chi tiết</a>
								</td>
	                          </tr>
                        	</c:forEach>
                        </tbody>
