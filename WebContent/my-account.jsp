...
<title>Tài khoản - Cheichei Store</title>
                    ...
                    <div class="col">
                      ...
                      <form action="my-account" method="post">
                        <div class="form-group">
                          ...
                          <input type="text"
                            class="form-control" value="${customer.getHoten()}" name="fullname" id="fullname" aria-describedby="helpFullName" placeholder="Enter Full Name">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text"
                            class="form-control" name="address"  value="${customer.getDiachi()}" id="address" aria-describedby="helpAddress" placeholder="Enter Address">
                          <small id="helpAddress" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group">
                          <label for="phoneNumber">Số điện thoại</label>
                          <input type="number"
                            class="form-control" value="${customer.getSdt()}" name="phoneNumber" id="phoneNumber" aria-describedby="hPhoneNumber" placeholder="Enter Phone Number">
